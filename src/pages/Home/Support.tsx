...
const Support = () => {
  return (
    <div className="grid md:grid-cols-2  h-72">
      <div className="bg-[#415364] w-full text-white flex flex-col justify-center pl-6">
      ...
      <div className="bg-[#ebebeb] w-full text-[#415364] flex flex-col justify-center pl-6">
